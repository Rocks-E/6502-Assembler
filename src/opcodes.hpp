...
static std::map<std::string, instr_info> instruction_map = {
	...
	{{"LDY"},{5,0xA0,0x037}},{{"LSR"},{5,0x42,0x836}},{{"LXA"},{1,0xAB,0x001}},{{"NOP"},{6,0xEA,0x837}}, {{"ORA"},{8,0x01,0x377}},{{"PHA"},{1,0x48,0x800}},{{"PHP"},{1,0x08,0x800}},{{"PLA"},{1,0x68,0x800}},
	...
	{{"SLO"},{7,0x03,0x376}},{{"SRE"},{7,0x43,0x376}},{{"STA"},{7,0x81,0x376}},{{"STX"},{3,0x82,0x01A}}, {{"STY"},{3,0x80,0x016}},{{"TAS"},{1,0x9B,0x040}},{{"TAX"},{1,0xAA,0x800}},{{"TAY"},{1,0xA8,0x800}},
